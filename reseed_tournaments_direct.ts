...
async function main() {
  console.log('🏓 Starting tournament database reseed...')
  ...
  try {
    ...
    console.log(`✅ Deleted ${deleteResult.count} existing tournaments`)
    ...
    console.log(`\n🎉 Successfully seeded ${createdCount} tournaments!`)
    console.log('✅ Tournament database reseed complete!')
  } catch (error) {
