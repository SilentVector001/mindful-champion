...
// REAL YouTube pickleball training videos - verified and working
const SAMPLE_VIDEOS: Video[] = [
  {
    id: 'real-1',
    videoId: 'x5ceh-7DI1Y',
    title: 'The 4 Golden Rules of Pickleball | Strategy for Doubles',
    url: 'https://www.youtube.com/watch?v=x5ceh-7DI1Y',
    channel: 'PrimeTime Pickleball',
    duration: '10:23',
    description: 'Learn the four essential strategies for pickleball doubles, including getting to the non-volley zone, keeping the ball in play, hitting to the middle, and targeting opponents.',
    skillLevel: 'BEGINNER',
    primaryTopic: 'Strategy',
    thumbnailUrl: 'https://i.ytimg.com/vi/x5ceh-7DI1Y/hqdefault.jpg',
    avgRating: 4.9,
    ratingCount: 1245,
    userVideoProgress: [],
    ratings: [],
  ...
  },
  {
    id: 'real-2',
    videoId: '7UqRszda8Aw',
    title: 'Pickleball SERVE - The 4 Keys To A GREAT SERVE',
    url: 'https://www.youtube.com/watch?v=7UqRszda8Aw',
    channel: 'Enhance Pickleball',
    duration: '8:31',
    description: 'This tutorial breaks down the four key components of a powerful and consistent pickleball serve, focusing on the toss, contact point, follow-through, and placement.',
    skillLevel: 'BEGINNER',
    primaryTopic: 'Serves',
    thumbnailUrl: 'https://i.ytimg.com/vi/7UqRszda8Aw/hqdefault.jpg',
    avgRating: 4.8,
    ratingCount: 892,
    userVideoProgress: [],
    ratings: [],
  ...
  },
  {
    id: 'real-3',
    videoId: 'FofHYpS03BM',
    title: 'The 4 DINKING ZONES In Pickleball - And How To Use Them!',
    url: 'https://www.youtube.com/watch?v=FofHYpS03BM',
    channel: 'PrimeTime Pickleball',
    duration: '12:45',
    description: 'Learn the concept of the four dinking zones and how to strategically use them to control the pace of the game and create offensive opportunities at the net.',
    skillLevel: 'INTERMEDIATE',
    primaryTopic: 'Dinking',
    thumbnailUrl: 'https://i.ytimg.com/vi/FofHYpS03BM/hqdefault.jpg',
    avgRating: 4.9,
    ratingCount: 756,
    userVideoProgress: [],
    ratings: [],
  ...
  },
  {
    id: 'real-4',
    videoId: 'u6jG0fqjQeY',
    title: 'How To Hit The 3rd Shot Drop PERFECTLY',
    url: 'https://www.youtube.com/watch?v=u6jG0fqjQeY',
    channel: 'Pickleball Kitchen',
    duration: '7:52',
    description: 'A step-by-step guide to mastering the third shot drop, including proper technique, footwork, and shot selection to effectively neutralize your opponents advantage.',
    skillLevel: 'INTERMEDIATE',
    primaryTopic: 'Third Shot Drop',
    thumbnailUrl: 'https://i.ytimg.com/vi/u6jG0fqjQeY/hqdefault.jpg',
    avgRating: 4.8,
    ratingCount: 1123,
    userVideoProgress: [],
    ratings: [],
  ...
  },
  {
    id: 'real-5',
    videoId: '1Y2zpXxK6ag',
    title: '5 Steps to a BETTER Pickleball Forehand Drive',
    url: 'https://www.youtube.com/watch?v=1Y2zpXxK6ag',
    channel: 'Briones Pickleball',
    duration: '9:11',
    description: 'Improve your forehand drive with five simple steps covering grip, swing path, contact point, and follow-through for more power and consistency.',
    skillLevel: 'BEGINNER',
    primaryTopic: 'Drives',
    thumbnailUrl: 'https://i.ytimg.com/vi/1Y2zpXxK6ag/hqdefault.jpg',
    avgRating: 4.7,
    ratingCount: 634,
    userVideoProgress: [],
    ratings: [],
  ...
  },
  {
    id: 'real-6',
    videoId: 'v2mGOohO_6c',
    title: 'Pickleball Footwork - Drills to Help You Move Better on the Court',
    url: 'https://www.youtube.com/watch?v=v2mGOohO_6c',
    channel: 'Selkirk TV',
    duration: '6:42',
    description: 'A series of footwork drills designed to improve your movement, balance, and court coverage. Essential for players of all levels looking to improve their game.',
    skillLevel: 'BEGINNER',
    primaryTopic: 'Footwork',
    thumbnailUrl: 'https://i.ytimg.com/vi/v2mGOohO_6c/hqdefault.jpg',
    avgRating: 4.6,
    ratingCount: 421,
    userVideoProgress: [],
    ratings: [],
  ...
  },
  {
    id: 'real-7',
    videoId: 'SQA1Cmb_LDI',
    title: 'The Most Important SHOT In Pickleball... The RETURN!',
    url: 'https://www.youtube.com/watch?v=SQA1Cmb_LDI',
    channel: 'Enhance Pickleball',
    duration: '11:02',
    description: 'Learn the importance of the return of serve and get tips on how to hit a deep, consistent return to gain an advantage in the point.',
    skillLevel: 'INTERMEDIATE',
    primaryTopic: 'Return of Serve',
    thumbnailUrl: 'https://i.ytimg.com/vi/SQA1Cmb_LDI/hqdefault.jpg',
    avgRating: 4.8,
    ratingCount: 567,
    userVideoProgress: [],
    ratings: [],
  ...
  },
  {
    id: 'real-8',
    videoId: 'wAez2X-zS1c',
    title: 'How To Play Aggressive (But Smart) At The Net In Pickleball',
    url: 'https://www.youtube.com/watch?v=wAez2X-zS1c',
    channel: 'PrimeTime Pickleball',
    duration: '13:01',
    description: 'Learn how to be more aggressive at the net without making unforced errors. Covers shot selection, positioning, and communication with your partner.',
    skillLevel: 'ADVANCED',
    primaryTopic: 'Strategy',
    thumbnailUrl: 'https://i.ytimg.com/vi/wAez2X-zS1c/hqdefault.jpg',
    avgRating: 4.9,
    ratingCount: 823,
    userVideoProgress: [],
    ratings: [],
  ...
  },
  {
    id: 'real-9',
    videoId: 'JGMLn68RZS8',
    title: 'Pickleball Volley Drills - Improve Your Reaction Time',
    url: 'https://www.youtube.com/watch?v=JGMLn68RZS8',
    channel: 'The Kitchen Pickleball',
    duration: '5:55',
    description: 'A series of volley drills that can be done with a partner to improve reaction time, hand-eye coordination, and control at the net.',
    skillLevel: 'INTERMEDIATE',
    primaryTopic: 'Volleys',
    thumbnailUrl: 'https://i.ytimg.com/vi/JGMLn68RZS8/hqdefault.jpg',
    avgRating: 4.7,
    ratingCount: 389,
    userVideoProgress: [],
    ratings: [],
  ...
  },
  {
    id: 'real-10',
    videoId: 'l-F6Guq9Lhw',
    title: 'The Mental Game of Pickleball - How to Stay Focused and Confident',
    url: 'https://www.youtube.com/watch?v=l-F6Guq9Lhw',
    channel: 'Pickleball Channel',
    duration: '15:30',
    description: 'Explore the mental side of pickleball with tips and strategies for staying focused, managing pressure, and maintaining confidence during matches.',
    skillLevel: 'ADVANCED',
    primaryTopic: 'Mental Game',
    thumbnailUrl: 'https://i.ytimg.com/vi/l-F6Guq9Lhw/hqdefault.jpg',
    avgRating: 4.8,
    ratingCount: 445,
    userVideoProgress: [],
    ratings: [],
  ...
  },
  {
    id: 'real-11',
    videoId: '6ECK_vb2jkQ',
    title: 'How To Defend Against The BANGER In Pickleball',
    url: 'https://www.youtube.com/watch?v=6ECK_vb2jkQ',
    channel: 'PrimeTime Pickleball',
    duration: '11:51',
    description: 'Strategies and techniques for defending against aggressive players who like to drive the ball hard. Learn to neutralize their power and reset the point.',
    skillLevel: 'INTERMEDIATE',
    primaryTopic: 'Strategy',
    thumbnailUrl: 'https://i.ytimg.com/vi/6ECK_vb2jkQ/hqdefault.jpg',
    avgRating: 4.9,
    ratingCount: 678,
    userVideoProgress: [],
    ratings: [],
  ...
  },
  {
    id: 'real-12',
    videoId: 'USVMB5zEzIc',
    title: 'Advanced Pickleball Strategy - How To "Erne"',
    url: 'https://www.youtube.com/watch?v=USVMB5zEzIc',
    channel: 'Briones Pickleball',
    duration: '6:21',
    description: 'Learn the "Erne," an advanced shot where a player legally hits the ball out of the air while standing outside the non-volley zone. A game-changing technique!',
    skillLevel: 'ADVANCED',
    primaryTopic: 'Strategy',
    thumbnailUrl: 'https://i.ytimg.com/vi/USVMB5zEzIc/hqdefault.jpg',
    avgRating: 4.8,
    ratingCount: 512,
    userVideoProgress: [],
    ratings: [],
