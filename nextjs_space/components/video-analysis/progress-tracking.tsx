          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription className="mt-2">
                <span className="block mb-1">Track your performance across all analyzed videos</span>
                <span className="text-xs text-cyan-400 flex items-center gap-1">
                  💡 <strong>Why this matters:</strong> See your improvement journey over time and identify which training sessions had the biggest impact
                </span>
              </CardDescription>
            </div>
          </div>
              ...
              >
                ...
                <Card className={cn(
                  ...
                  <CardContent className="p-4">
                    ...
                    {video.current && currentAnalysis?.id && (
                      <Button size="sm" className="w-full bg-purple-500 hover:bg-purple-600" asChild>
        ...
        <CardHeader>
          <div className="space-y-3">
            <CardTitle className="text-white flex items-center gap-2">
              ...
              Progress Comparison: First Analysis vs Latest
            </CardTitle>
            <CardDescription>
              <span className="block mb-2">See how much you've improved since your first video analysis</span>
              <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-lg p-3 text-xs">
                <div className="flex items-start gap-2">
                  <div className="flex-shrink-0 mt-0.5">💡</div>
                  <div className="space-y-1">
                    <p className="text-cyan-300 font-semibold">What am I looking at?</p>
                    <p className="text-slate-300">
                      <span className="font-semibold text-slate-400">• "Your First Analysis"</span> - Your baseline performance from your very first uploaded video
                    </p>
                    <p className="text-slate-300">
                      <span className="font-semibold text-emerald-400">• "Your Latest Performance"</span> - This current video you're viewing
                    </p>
                    <p className="text-slate-300 mt-2">
                      The green improvement badges show how many points you've gained in each category!
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    <div className="flex justify-between text-xs mb-2">
                      <span className="text-slate-400 font-semibold">📊 Your First Analysis</span>
                  ...
                  <div>
                    <div className="flex justify-between text-xs mb-2">
                      <span className="text-emerald-400 font-semibold">🎯 Your Latest Performance</span>
