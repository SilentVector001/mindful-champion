...
export default function SimpleLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      {/* BEFORE/AFTER TRANSFORMATION - Moved after Video Analysis */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative">
          ...
          >
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Our AI identifies technique issues and guides you to proper form.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            ...
            >
              ...
              <div className="relative bg-slate-800/90 border border-red-500/30 rounded-2xl overflow-hidden">
                <div className="absolute top-4 left-4 z-10">
                  <span className="bg-red-500 text-white text-sm font-bold px-4 py-2 rounded-full shadow-lg">BEFORE</span>
                </div>
                <div className="relative aspect-[4/3]">
                  <Image src="https://cdn.abacus.ai/images/2852a913-6784-41b2-9abf-85a2d94c8d18.png" alt="Poor technique" fill className="object-cover" />
                </div>
            ...
            >
              ...
              <div className="relative bg-slate-800/90 border border-emerald-500/30 rounded-2xl overflow-hidden">
                <div className="absolute top-4 left-4 z-10">
                  <span className="bg-emerald-500 text-white text-sm font-bold px-4 py-2 rounded-full shadow-lg">AFTER</span>
                </div>
                <div className="relative aspect-[4/3]">
                  <Image src="https://cdn.abacus.ai/images/567b4691-30cb-4ef6-94b9-3af2089849cf.png" alt="Correct technique" fill className="object-cover" />
                </div>
                <div className="p-4 bg-gradient-to-t from-slate-900 via-slate-900/90 to-transparent">
