          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="border-0 shadow-md">
              <CardContent className="p-8">
                ...
                <div className="text-5xl font-light text-gray-900 dark:text-white mb-2">
                  {currentStreak}<span className="text-3xl text-gray-500 dark:text-gray-300"> days</span>
                </div>
            ...
            <Card className="border-0 shadow-md">
              <CardContent className="p-8">
                ...
                <div className="text-5xl font-light text-gray-900 dark:text-white mb-2">
                  {totalSessionsThisWeek}<span className="text-3xl text-gray-500 dark:text-gray-300"> sessions</span>
                </div>
            ...
            <Card className="border-0 shadow-md">
              <CardContent className="p-8">
                ...
                <div className="text-5xl font-light text-gray-900 dark:text-white mb-2">
                  15<span className="text-3xl text-gray-500 dark:text-gray-300"> min</span>
                </div>
