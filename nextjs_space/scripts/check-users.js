            ...
            switch (_a.label) {
                ...
                case 3:
                    ...
                    users.forEach(function (user, i) {
                        console.log("".concat(i + 1, ". ").concat(user.email));
                        ...
                        console.log("   Email Verified: ".concat(user.emailVerified ? 'Yes' : 'No'));
                        console.log("   Videos: ".concat(user._count.videoAnalyses));
