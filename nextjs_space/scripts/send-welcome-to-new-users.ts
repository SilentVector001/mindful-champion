...
async function main() {
  const users = [
    { email: 'HipPOPscpo@outlook.com', firstName: 'Anthony' },
    { email: 'Kpm0731@yahoo.com', firstName: 'Kris' }
  ]
  ...
  for (const userInfo of users) {
    try {
          ...
          <div class="container">
            ...
            <div class="content">
              ...
              <ul>
                ...
                <li><strong>Joined:</strong> ${user.createdAt.toLocaleString()}</li>
              </ul>
      ...
      await Promise.all([
        ...
        sendEmail(OWNER_EMAIL, `New Signup: ${userName}`, ownerNotification)
      ])
