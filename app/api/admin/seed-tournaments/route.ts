...
const REAL_TOURNAMENTS: any[] = [
  ...
  },
  {
    ...
    entryFee: 95,
    prizePool: 125000,
    websiteUrl: 'https://www.theapp.global/tourfort-lauderdale-open',
    registrationUrl: 'https://www.theapp.global/tourfort-lauderdale-open',
    latitude: 26.1223,
    longitude: -80.1434,
  ...
  },
  {
    ...
    entryFee: 85,
    prizePool: 100000,
    websiteUrl: 'https://www.theapp.global/tourdaytona-beach-open',
    registrationUrl: 'https://www.theapp.global/tourdaytona-beach-open',
    latitude: 29.2395,
    longitude: -81.0345,
    status: TournamentStatus.REGISTRATION_OPEN,
  ...
  },
  {
    ...
    entryFee: 85,
    prizePool: 100000,
    websiteUrl: 'https://www.theapp.global/touratlanta-open',
    registrationUrl: 'https://www.theapp.global/touratlanta-open',
    latitude: 33.9167,
    longitude: -84.3356,
    status: TournamentStatus.REGISTRATION_OPEN,
  ...
  },
  {
    ...
    entryFee: 90,
    prizePool: 110000,
    websiteUrl: 'https://www.theapp.global/tourchicago-open',
    registrationUrl: 'https://www.theapp.global/tourchicago-open',
    latitude: 41.9244,
    longitude: -87.6631,
    status: TournamentStatus.REGISTRATION_OPEN,
  ...
  },
  {
    ...
    entryFee: 85,
    prizePool: 100000,
    websiteUrl: 'https://www.theapp.global/tourseattle-open',
    registrationUrl: 'https://www.theapp.global/tourseattle-open',
    latitude: 47.6167,
    longitude: -122.3089,
    status: TournamentStatus.REGISTRATION_OPEN,
...
export async function POST(request: Request) {
  try {
    ...
    console.log(`✅ Successfully seeded ${createdCount} tournaments!`)
