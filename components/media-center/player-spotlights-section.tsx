...
const FEATURED_PLAYERS: PlayerProfile[] = [
  {
    id: '1',
    name: 'Ben Johns',
    imageUrl: 'https://images.unsplash.com/photo-1642104798671-01a4129f4fdc?w=300&h=300&fit=crop&crop=face',
    rank: 1,
  ...
  },
  {
    ...
    imageUrl: 'https://plus.unsplash.com/premium_photo-1754269275982-8b832fe59547?w=300&h=300&fit=crop&crop=face',
    rank: 1,
  ...
  },
  {
    id: '3',
    name: 'Tyson McGuffin',
    imageUrl: 'https://plus.unsplash.com/premium_photo-1749494938040-63c4f922ca1b?w=300&h=300&fit=crop&crop=face',
    rank: 2,
    category: 'mens-singles',
    nationality: '🇺🇸',
    titles: 45,
  ...
  },
  {
    ...
    imageUrl: 'https://plus.unsplash.com/premium_photo-1709932755918-463c3bd03818?w=300&h=300&fit=crop&crop=face',
    rank: 3,
    category: 'womens-singles',
    nationality: '🇨🇦',
    titles: 38,
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1761644658016-324918bc373c?w=300&h=300&fit=crop&crop=face',
    rank: 4,
    category: 'mens-singles',
    nationality: '🇦🇷',
    titles: 22,
  ...
  },
  {
    id: '6',
    name: 'Riley Newman',
    imageUrl: 'https://plus.unsplash.com/premium_photo-1749494937793-b9debb20b52b?w=300&h=300&fit=crop&crop=face',
    rank: 3,
    category: 'mens-singles',
    nationality: '🇺🇸',
    titles: 42,
